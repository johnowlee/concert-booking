...
import hhplus.concert.core.transaction.infrastructure.adapter.TransactionQueryAdapter;
...
@Transactional
class TransactionCoreReaderRepositoryTest extends IntegrationTestSupport {

    @Autowired
    TransactionQueryAdapter balanceCoreReaderRepository;
